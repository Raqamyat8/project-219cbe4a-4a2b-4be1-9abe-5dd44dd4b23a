...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "أكاديمية نُخبة — منصة تعليمية حديثة" },
      { name: "description", content: "منصة تعليمية عربية حديثة تجمع بين أفضل المحتوى التعليمي وتجربة تعلم مرنة للطلاب والمعلمين." },
